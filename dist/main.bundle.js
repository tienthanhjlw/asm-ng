...
module.exports = "<div class=\"form-group form-inline\">\r\n  <input type=\"text\" class=\"form-control\" [(ngModel)]=\"textValue\" (keyup.enter)=\"onClickHandler(textValue)\">\r\n  <button class=\"btn btn-primary\" (click)=\"onClickHandler(textValue)\">Add</button>\r\n</div>"
...
var AddComponent = (function () {
    ...
    AddComponent.prototype.onClickHandler = function () {
        if (this.textValue !== '') {
    ...
    ], AddComponent.prototype, "add", void 0);
...
module.exports = "<app-header></app-header>\r\n<br>\r\n<div class=\"container\">\r\n  <div class=\"row\">\r\n    <div class=\"col-8\">\r\n      <app-add (add)=\"onAdd($event)\"></app-add>\r\n    </div>\r\n    <div class=\"col-4\">\r\n      <app-search (search)=\"onSearch($event)\"></app-search>\r\n    </div>\r\n  </div>\r\n  <div *ngIf=\"searching == true\">\r\n    <p>Have {{ search.length }} results</p>\r\n    <app-list-item [items]=\"search\" (itemDeletedId)=\"deleteItem($event)\"></app-list-item>\r\n  </div>\r\n  <div *ngIf=\"searching == false\">\r\n    <app-list-item [items]=\"items\"  (itemDeletedId)=\"deleteItem($event)\"></app-list-item>\r\n  </div>\r\n</div>  "
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.onSearch = function (search) {
        if (search == '') {
            ...
            this.searching = true;
            this.search = this.items.filter(function (e) { return e.indexOf(search) > -1; });
        }
    };
...
module.exports = "{{item}} <button type=\"button\" class=\"btn btn-danger float-right\" (click)=\"delete()\">Delete</button>"
...
var ItemComponent = (function () {
    function ItemComponent() {
        this.itemDeleted = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* EventEmitter */]();
    }
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* Output */])(),
        __metadata("design:type", Object)
    ], ItemComponent.prototype, "itemDeleted", void 0);
...
module.exports = "<ul class=\"list-group\">\r\n  <li class=\"list-group-item justify-content-between\" *ngFor=\"let item of items; let i = index\"><app-item [item]=\"item\" [index]=\"i\" (itemDeleted)=\"sendItemDeletedId($event)\"></app-item></li>\r\n</ul>"
...
var ListItemComponent = (function () {
    function ListItemComponent() {
        this.itemDeletedId = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* EventEmitter */]();
        this.indexItems = [];
    }
    ListItemComponent.prototype.ngOnInit = function () {
    };
    ListItemComponent.prototype.sendItemDeletedId = function (index) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* Output */])(),
        __metadata("design:type", Object)
    ], ListItemComponent.prototype, "itemDeletedId", void 0);
...
module.exports = "<div class=\"form-group form-inline\">\r\n  <input type=\"text\" placeholder=\"Search\" class=\"form-control\" id=\"search\" (keyup)=\"onSearch($event)\">\r\n</div>"
...
var SearchComponent = (function () {
    function SearchComponent() {
        this.search = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* EventEmitter */]();
    }
